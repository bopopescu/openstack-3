...
class virDomain:
    ...
    def blockCommit(self, disk, base, top, bandwidth, flags):
    ...
    def emulatorPinInfo(self, cpumap, maplen, flags):
        """Query the CPU affinity setting of all emulator threads of domain, store
        it in cpumap. """
        ret = libvirtmod.virDomainGetEmulatorPinInfo(self._o, cpumap, maplen, flags)
        if ret == -1: raise libvirtError ('virDomainGetEmulatorPinInfo() failed', dom=self)
        return ret
    ...
    def pinEmulator(self, cpumap, maplen, flags):
        ...
        ret = libvirtmod.virDomainPinEmulator(self._o, cpumap, maplen, flags)
...
class virNetwork:
    ...
    def update(self, command, section, parentIndex, xml, flags):
...
class virConnect:
    ...
    def registerCloseCallback(self, cb, opaque, freecb):
        ...
        context. """
        ret = libvirtmod.virConnectRegisterCloseCallback(self._o, cb, opaque, freecb)
        if ret == -1: raise libvirtError ('virConnectRegisterCloseCallback() failed', conn=self)
        return ret
    ...
    def unregisterCloseCallback(self, cb):
        """Unregisters the callback previously set with the
        virConnectRegisterCloseCallback method. The callback
        will no longer receive notifications when the connection
        closes. If a virFreeCallback was provided at time of
        registration, it will be invoked """
        ret = libvirtmod.virConnectUnregisterCloseCallback(self._o, cb)
    ...
    def getMemoryParameters(self, flags):
...
class virDomainSnapshot:
    ...
    def ref(self):
        ...
        ret = libvirtmod.virDomainSnapshotRef(self._o)
        if ret == -1: raise libvirtError ('virDomainSnapshotRef() failed')
        return ret
